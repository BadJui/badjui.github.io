...
if(isUndefined(sliderun)) {
	...
	function slide() {
		...
		s.loadImage = function () {
			...
			document.write('<div id="switch_'+s.slideId+'" style="position:absolute;margin-top:-19px;margin-left:1px;"></div>');
